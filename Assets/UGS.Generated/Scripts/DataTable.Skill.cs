...
namespace DataTable
{
    ...
    { 
        ...
        public delegate void OnLoadedFromGoogleSheets(List<Skill> loadedList, Dictionary<int, Skill> loadedDictionary);
...
/* Your Loaded Data Storage. */
        ...
        public static Dictionary<int, Skill> SkillMap = new Dictionary<int, Skill>();  
        ...
        /// - Auto Load
        /// </summary>
        public static Dictionary<int, Skill>  GetDictionary()
        {{
           if (isLoaded == false) Load();
           return SkillMap;
        }}
...
/* Fields. */
		...
		public System.Int32 sk_bagic;
		public System.Int32 sk_increase;
		public System.Int32 sk_count;
		public System.Collections.Generic.List<Int32> sk_need;
		public System.Collections.Generic.List<Int32> sk_upper;
...
#region fuctions
        ...
        public static void LoadFromGoogle(System.Action<List<Skill>, Dictionary<int, Skill>> onLoaded, bool updateCurrentData = false)
        {      
    ...
    public static (List<Skill> list, Dictionary<int, Skill> map) CommonLoad(Dictionary<string, Dictionary<string, List<string>>> jsonObject, bool forceReload){
            Dictionary<int, Skill> Map = new Dictionary<int, Skill>();
